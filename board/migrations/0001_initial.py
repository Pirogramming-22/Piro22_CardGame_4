    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('defend_num', models.IntegerField(null=True, verbose_name='방어자 카드 숫자')),
                ('status', models.CharField(choices=[('진', '진행중'), ('종', '종료')], default='진', max_length=1, verbose_name='상태')),
                ('result', models.CharField(choices=[('A', 'Attacker'), ('D', 'Defender')], max_length=1, null=True, verbose_name='결과')),
